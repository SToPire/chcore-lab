...
void exception_init(void) { exception_init_per_cpu(); }
...
void handle_entry_c(int type, u64 esr, u64 address) {
  ...
  switch (esr_ec) {
    /*
     * Lab3: Your code here
     * Handle exceptions as required in the lab document. Checking exception
     * codes in esr.h may help.
     */
  case ESR_EL1_EC_DABT_LEL: do_page_fault(esr, address); break;
